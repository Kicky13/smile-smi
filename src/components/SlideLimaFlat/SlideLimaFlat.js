...
class SlideLimaFlat extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        //category CSR
        Http.get(
            process.env.REACT_APP_SMILE_API + "api/articlecategory/catdinamis/6/9"
        )
            .then(res => {
                this.setState({
        ...
        //category Bisnis
        Http.get(
            process.env.REACT_APP_SMILE_API + "api/articlecategory/catdinamis/7/9"
        )
            .then(res => {
                this.setState({
        ...
        //category Kilas
        Http.get(
            process.env.REACT_APP_SMILE_API + "api/articlecategory/catdinamis/5/9"
        )
            .then(res => {
                this.setState({
            ...
            //Lifestyle
            Http.get(
                process.env.REACT_APP_SMILE_API + "api/articlecategory/catdinamis/12/9"
            )
                .then(res => {
                    this.setState({
